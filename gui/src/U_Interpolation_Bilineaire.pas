...
function ReSizeBMP(FileName : string ; const Width, Height : integer) : boolean;

implementation

//-----REDIMENSIONNEMENT_PAR_INTERPOLATION_BILINEAIRE--------------------
procedure REDIMENSIONNEMENT_PAR_INTERPOLATION_BILINEAIRE (BMP : TBitmap; const Largeur, Hauteur : integer);
type
...
begin
  ...
  try
    ...
    REDIMENSIONNEMENT_PAR_INTERPOLATION_BILINEAIRE(Img.Picture.Bitmap, Width, Height);
